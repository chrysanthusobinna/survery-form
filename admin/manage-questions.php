                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm edit-question-btn" data-toggle="modal"
                                    ...
                                    data-count-score="<?php echo $question['CountScore']; ?>"><i
                                        class="fas fa-edit"></i></button>

                                <button class="btn btn-danger btn-sm delete-question-btn" data-toggle="modal"
                                    data-target="#deleteQuestionModal" data-id="<?php echo $question['QuestionID']; ?>"><i
...
if (isset($_POST["editQuestionForm"])) {
    ...
    // Validate $rangeMin and $rangeMax
    validateInteger($rangeMin, 'RangeMin');
    validateInteger($rangeMax, 'RangeMax');

    // Validate $countScore
    validateCountScore($countScore);
